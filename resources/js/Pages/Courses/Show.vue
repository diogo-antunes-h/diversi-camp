            ...
            <div class="p-5 bg-white dark:bg-gray-800 dark:text-white shadow-xl rounded-lg">
                ...
                <div class="mt-5 mx-auto w-fit">
                    <form @submit.prevent="isSubscribed ? unsubscribe() : subscribe()">
                        <button @mouseover="mouseOnUnsubscribe = true" @mouseleave="mouseOnUnsubscribe = false" :disabled="formSubscribe.processing || formUnsubscribe.processing" class="border rounded-md py-3 px-5 hover:bg-gray-400 hover:text-white dark:hover:bg-white dark:hover:text-black w-40" action="submit">
